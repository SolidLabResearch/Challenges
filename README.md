...
Everybody is free to add new challenges using the provided template that you select when creating a new issues.
This template helps you with providing the information that is needed for a challenge to considered.
